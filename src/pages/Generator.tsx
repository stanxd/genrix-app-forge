...
const Generator = () => {
  ...
  const generateResponse = (prompt: string) => {
    const responses = [
      `I've generated a Next.js application based on your prompt: "${prompt}". The app includes React components, Tailwind CSS styling, and basic functionality. You can see a preview on the right panel.`,
      `Your Next.js app is ready! I've created components for "${prompt}" with modern design principles and responsive layouts. Check out the preview to see how it looks.`,
      `I've built the app structure for "${prompt}" using Next.js, TypeScript and modern React patterns. The preview shows the current state of the application.`
    ];
