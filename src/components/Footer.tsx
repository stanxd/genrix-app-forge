      ...
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12">
          <div className="lg:col-span-2">
            ...
            <div className="flex space-x-4">
              <a href="#" className="text-white/60 hover:text-genrix-purple transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-3 text-white/70">
              {links.product.map((link, index) => (
                <li key={index}>
                  <a href={link.href} className="hover:text-genrix-purple transition-colors">
                    {link.name}
                  </a>
                </li>
              ))}
        ...
        <div className="border-t border-white/10 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          <div className="text-white/50 mb-4 md:mb-0">
            © {currentYear} Genrix. All rights reserved.
          </div>
          <div className="flex space-x-6">
            {links.legal.map((link, index) => (
              <a key={index} href={link.href} className="text-white/50 hover:text-genrix-purple transition-colors">
                {link.name}
              </a>
            ))}
          </div>
